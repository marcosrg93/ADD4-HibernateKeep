...
public class Keep implements java.io.Serializable {
    ...
    public Keep(Integer id, Usuario usuario, Integer idAndroid, String contenido, String ruta, String estado) {
        this.id = id;
        this.usuario = usuario;
        this.idAndroid = idAndroid;
        this.contenido = contenido;
    ...
    public Keep(Integer id, Integer idAndroid, String contenido, String ruta, String estado) {
        this.id = id;
        this.usuario = null;
        this.idAndroid = idAndroid;
        this.contenido = contenido;
